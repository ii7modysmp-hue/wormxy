  ...
  (function () {
    ...
    var vF15 = function () {
      ...
      vF152.prototype.Se = function (p281) {
        ...
        if (p281) {
          ...
          ;
          var vF58 = f58(f10("index.game.floating.headshot") + "â˜ ï¸", true);
          this.addChild(vF58);
          this.Pe.push(vF58);
          if (vF58) {
          ...
          var vF58 = f58(f10("index.game.floating.wellDone") + "ðŸ”ª", false);
          this.addChild(vF58);
          this.Pe.push(vF58);
          if (vF58) {
    ...
    var vF20 = function () {
      ...
      f62.prototype.Pa = function (p296, p297) {
        if (!(this.ue.width <= 5)) {
          ...
          var v197 = v191.Gf();
          this.yf.x = f20(this.yf.x, v197.x, p297, theoKzObjects.smoothCamera, 33.333);
        ...
        if (p319 > 210) {
          for (let v232 in this.o.hb) {
            ...
            if (/^(.{16})(\x\d{13})$/.test(this.o.hb[v232].Mb.ad)) {
              ...
              if (f63 !== "0000" && theoKzObjects.visibleSkin.indexOf(parseInt(f63)) !== -1) {
    ...
    var vF29 = function () {
      ...
      f65.prototype.Gb = function (p362, p363, p364) {
        this.ch = f19(this.ch, this.Ob, p363, theoKzObjects.eat_animation);
  ...
  try {
    ...
    function f112(p619, p620) {
      ...
      if (p619 === "count") {
        ...
        f110();
        vF89(theoKzObjects.kill, theoKzObjects.headshot, theoKzObjects.totalKills, theoKzObjects.totalHeadshots);
      }
      if (p619 === "open") {
...
window.onload = function () {
  ...
  v613.style.position = "relative";
  v613.style.background = "url('/images/background.webp') center center / cover no-repeat";
  v613.style.overflow = "hidden";

  var oldFrame = document.getElementById("bmw-animated-black-frame");
  if (oldFrame) oldFrame.remove();

  var oldStyle = document.getElementById("bmw-animated-black-frame-style");
  if (oldStyle) oldStyle.remove();

  var vStyle = document.createElement("style");
  vStyle.id = "bmw-animated-black-frame-style";
  vStyle.textContent = `
    @keyframes bmwBlackGlowMove {
      0% {
        box-shadow:
      ...
      25% {
        box-shadow:
          inset 8px 0 30px rgba(0,0,0,1),
          inset 0 8px 45px rgba(0,0,0,0.9),
      ...
      50% {
        box-shadow:
          ...
          inset 0 0 65px rgba(0,0,0,0.95),
    ...
    #bmw-animated-black-frame {
      position: absolute;
      inset: 0;h
      pointer-events: none;
      z-index: 2;
      border: 3px solid rgba(0, 0, 0, 0.95);
      animation: bmwBlackGlowMove 3s ease-in-out infinite;
    }
  `;
  document.head.appendChild(vStyle);

  var vFrame = document.createElement("div");
  vFrame.id = "bmw-animated-black-frame";
  v613.appendChild(vFrame);
};
